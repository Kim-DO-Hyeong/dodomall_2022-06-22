                ...
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                  <div class="col-10 col-sm-8 col-lg-6">
                    ...
                    <img src="http://localhost/dodomall/images/product/${imgFileName }" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
	                  ...
	                  <form action="http://localhost/dodomall/product/buy" method="POST">
		                  <div class="col-lg-6">
		                    ...
		                    <div class="d-grid gap-2 d-md-flex justify-content-md-start">
		                      <button type="submit" class="btn btn-primary btn-lg px-4 me-md-2" id="buy_btn">구매 하기</button>
		                    </div>
		                    <input type="text" name="productIdx" value="${productInfo.productIdx }" style="display:none"/>
		                    <input type="text" name="paymentMethod" placeholder="결제방법"/>
		                  </div>
					</form>	                                  
                </div>
              </div>
